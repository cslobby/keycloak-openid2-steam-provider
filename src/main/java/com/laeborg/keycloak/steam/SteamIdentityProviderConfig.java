 ...
 *
 * <p>Extends {@link OAuth2IdentityProviderConfig} so that
 * {@link SteamIdentityProvider} can extend {@link org.keycloak.broker.oidc.AbstractOAuth2IdentityProvider}
 * and inherit its registered {@code Endpoint} sub-resource type.</p>
 *
